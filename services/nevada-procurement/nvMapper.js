/**
 * Nevada Procurement Mapper
 * Converts raw Nevada procurement records into unified contract objects
 * used by the NGCC unified feed.
 */

export const nvMapper = {
  map(record) {
    return {
      ...
      agency: record.agency || record.department || "Nevada State Agency",
